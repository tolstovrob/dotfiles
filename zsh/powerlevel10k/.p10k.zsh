...
POWERLEVEL9K_CONTEXT_{DEFAULT,ROOT}_CONTENT_EXPANSION=''
...
POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND=2
POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS}_FOREGROUND=1
...
POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=2
